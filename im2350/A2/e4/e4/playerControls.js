...
I want to adjust the audio off or on
  ...
  Affordance - I want to toggle between mute and unmute (be specific)
  ...
  */
  ...
  function muteUnmute(){
    ...
    //Note to self: if else thing is to cite my reference. 
  ...
  playbackButton.addEventListener('click', dropDown);
    ...
    playbackRateButton.style.backgroundImage = "url('./icons/fastForward.svg')";
    document.getElementById("videoPlayOverlay").style.display="none";
